...
const formItem = [
  ...
  { type: 'upload', label: '导入数据', placeholder: '请上传导入数据', model: 'ddd', accept: '.doc, .docx, .xls, .xlsx', hasTemplate: true }
]
...
const rules:any = {
  ...
  ccc: [{ required: true, message: '请选择服务订单', whitespace: true, type: 'number' }],
  ddd: [{ required: true, message: '请上传导入数据', whitespace: true, type: 'any' }]
}
