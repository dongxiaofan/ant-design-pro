...
const formItem = [
  ...
  { type: 'areaCascader', label: '企业所在地', placeholder: '请选择企业所在地', model: 'ggg' },
  { type: 'input', label: '详细地址', placeholder: '请输入详细地址', model: 'iii', style: 'hide-label' },
  { type: 'input', label: '联系方式', placeholder: '请输入联系方式', model: 'hhh' },
]

// 验证规则
const rules:any = {
  aaa: [{ required: true, message: '请输入客户名称', whitespace: true, type: 'string' }],
  bbb: [{ required: true, message: '请输入组织机构代码', whitespace: true, type: 'string' }],
  ccc: [{ required: true, message: '请输入纳税编号', whitespace: true, type: 'string' }],
  ddd: [{ required: true, message: '请选择企业类型', whitespace: true, type: 'number' }],
  eee: [{ required: true, message: '请选择所属行业', whitespace: true, type: 'number' }],
  fff: [{ required: true, message: '请选择企业规模', whitespace: true, type: 'number' }],
  ggg: [{ required: true, message: '请选择企业所在地', whitespace: true, type: 'array' }],
  iii: [{ required: true, message: '请输入详细地址', whitespace: true, type: 'string' }],
  hhh: [{ required: true, message: '请输入联系方式', whitespace: true, type: 'string' } ]
}
