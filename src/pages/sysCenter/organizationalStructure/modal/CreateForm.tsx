...
// 表单字段
const formItem = [
  { type: 'input', label:'部门名称', placeholder: '请输入部门名称', model: 'aaa' },
  { type: 'select', label: '上级部门', placeholder: '请输入上级部门', model: 'bbb', options: 'tempOps' }
]

// 验证规则
const rules:any = {
  aaa: [{ required: true, message: '请输入部门名称', whitespace: true, type: 'string' }],
  bbb: [{ required: true, message: '请输入上级部门', whitespace: true, type: 'number' }]
}
